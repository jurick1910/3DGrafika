...
int main()
{
    ...
    Sphere s1(Vec3f(-5, 0, -15), 2, blue);
    Sphere s2(Vec3f(5.0, -0.5, -20), 4, green);

    Cuboid s4(Vec3f( -20, -10, -35), Vec3f(20, -9, -12), red);
    Cuboid s5(Vec3f(-5, -5, -10), Vec3f(-2, -2, -8), grey);

    Objects objs = {&s1, &s2, &s4, &s5};
    
    // definiraj svjetla
    Light l1 = Light(Vec3f(30, 15, 10), 1500);
    Light l2 = Light(Vec3f(-20, 10, 20), 700);
    Lights lights = {&l1, &l2};
